      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Experience our jewelry collection in person. Visit our showroom for personalized consultation 
          ...
          <div className="space-y-8">
            <Card className="card-luxury">
              <CardContent className="p-0">
                <div className="aspect-video bg-gradient-to-br from-muted/20 to-muted/40 rounded-xl flex items-center justify-center">
            ...
            <Card className="card-luxury">
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground mb-6">
                  Have a question about our jewelry or want to schedule a consultation? 
