      ...
      <div className="container mx-auto max-w-6xl">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              <div className="text-3xl font-playfair font-bold text-gold-gradient">MJ</div>
              <div>
            ...
            <p className="text-muted-foreground">
              Crafting exquisite jewelry with traditional artistry and modern elegance. 
          ...
          <div className="space-y-4">
            ...
            <nav className="space-y-2">
              <a href="#collection" className="block text-muted-foreground hover:text-primary transition-smooth">
                Our Collection
              </a>
        ...
        <div className="border-t border-primary/20 mt-8 pt-8 text-center">
          <p className="text-muted-foreground text-sm">
            © 2024 Mansa Jewellers (MJ). All rights reserved. | 
            <span className="text-primary"> Designed by Samin Shaikh (Raj)</span>
          </p>
        </div>
      </div>
    </footer>
